...
alter table debt add constraint fk_debt_client_1 foreign key (client) references client (id);
create index ix_debt_client_1 on debt (client);
alter table financial_asset add constraint fk_financial_asset_client_2 foreign key (client) references client (id);
create index ix_financial_asset_client_2 on financial_asset (client);
alter table income add constraint fk_income_client_3 foreign key (client) references client (id);
create index ix_income_client_3 on income (client);
alter table referral add constraint fk_referral_user_id_4 foreign key (user_id) references user_model (id);
create index ix_referral_user_id_4 on referral (user_id);
...
drop table if exists financial_asset cascade;
